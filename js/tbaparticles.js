...
jQuery(function(a) {
    a.fn.vcParticlesBackground = function() {
        ...
        // If compatibility isset then apply else return ".vc_vcrow etc..."
        function t(a) {
			var classname = e.attr("data-particles-compatibility-customclass") ? e.attr("data-particles-compatibility-customclass") : "";
            return a.parents(classname + " .vc_vcrow, .vc_row, .wpb_row").eq(0);
        }
				
		var zindex = e.attr("data-particles-compatibility-zindex") ? e.attr("data-particles-compatibility-zindex") : "2";
        r.css("position", "relative"), r.prepend('<div id="' + i + '" class="tba-particles-background-bg" style="top: 0;  position: absolute; left: 0; width: 100%; height: 100%; z-index:' + zindex + ';"></div>'), particlesJS(i, {
            particles: {
                number: {
    ...
    }, a(".tba-particles-background").each(function() {
